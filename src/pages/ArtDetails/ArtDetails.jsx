...
const ArtDetails = () => {
    ...
    const handleDelete = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://artify-server-weld.vercel.app/artworks/${artwork._id}`, {
                    method: 'DELETE',
                    headers: {
    ...
    useEffect(() => {
        ...
        if (!hasViewed.current) {
            fetch(`https://artify-server-weld.vercel.app/artworks/view/${id}`, {
                method: "PATCH"
            });
        ...
        fetch(`https://artify-server-weld.vercel.app/artworks/${id}`)
            .then(res => res.json())
            .then(data => {
                console.log(data);
                setArtwork(data);
    ...
    const handleLike = () => {
        fetch(`https://artify-server-weld.vercel.app/artworks/like/${artwork._id}`, {
            method: "PATCH"
        })
            .then(res => res.json())
            .then(() => {
    ...
    const handleFavorite = () => {
        ...
        fetch("https://artify-server-weld.vercel.app/favourites", {
            method: "POST",
            headers: {
                "Content-type": "application/json"
            },
