    ...
    <footer className="bg-base-100 border-t border-base-300 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold text-primary mb-2">Artify</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a className="text-sm text-base-content/70 hover:text-primary transition-colors">
                  Home
                </a>
              </li>
              <li>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold text-base-content mb-4">Contact</h4>
            ...
            <div className="flex gap-3">
              <a className="w-9 h-9 bg-primary text-primary-content rounded-lg flex items-center justify-center hover:opacity-80 transition">
                <Twitter size={16} />
              </a>
